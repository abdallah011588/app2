...
import 'package:app2/layout/home_layout.dart';
...
import 'package:app2/modules/shop_app/categories/categories.dart';
import 'package:app2/modules/shop_app/favorites/favorites.dart';
import 'package:app2/modules/shop_app/products/products.dart';
import 'package:app2/modules/shop_app/settings/settings_screen.dart';
...
class shopCubit extends Cubit<shopStates>{
  ...
  {
    emit(shopChangeBottomNavlState());
    currentIndex=value;
  }
  ...
  void getHomeData()
  {
    ...
    dioHelper.getData(url:HOME,token:token).then((value)
    {
     ...
     // printFullText(homemodel!.data.banners[0].image.toString());
      ...
      emit(shopErrorHomeDataState(error: onError.toString()));
    });
  ...
  void getCategoriesData()
  {
    ...
    dioHelper.getData(url:Get_CATEGORIES,).then((value)
    {
      ...
      print(onError.toString());
      emit(shopErrorCategoriesState(error: onError.toString()));
    });
   ...
   void getUserData()
  {
    ...
    {
      print(' errorrr in the shopCubit${error.toString()}');
...
/*
        ...
        "ad": "https://student.valuxapps.com/storage/uploads/banners/1626545208UfigP.golden-coin-money-cashback-promotion-ecommerce-poster-banner-template-blue-background-216757528.jpg"
    }
}
 */
 */