  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<appcubit,appstates>(
      ...
      builder: (context, state) {
        return  appcubit.get(context).archivedtasks.length>0? ListView.separated( itemBuilder: (context, index) =>itembuild(appcubit.get(context).archivedtasks[index],context) ,
